    ...
    <footer className="py-12 bg-transparent text-center relative z-10">
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center">
        ...
        <div className="flex items-center gap-4 mb-8">
          {/* Telegram */}
          <a
            href="https://t.me/tg_clubmanagers"
            target="_blank"
            rel="noopener noreferrer"
            className="w-14 h-14 bg-white rounded-[20px] flex items-center justify-center text-slate-900 shadow-lg shadow-slate-200/50 hover:scale-110 transition-transform hover:shadow-xl duration-300 group"
          >
            <svg className="w-6 h-6 group-hover:text-[#229ED9] transition-colors" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="w-14 h-14 bg-white rounded-[20px] flex items-center justify-center text-slate-900 shadow-lg shadow-slate-200/50 hover:scale-110 transition-transform hover:shadow-xl duration-300 group"
          >
            <svg className="w-6 h-6 group-hover:text-[#E1306C] transition-colors" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="w-14 h-14 bg-white rounded-[20px] flex items-center justify-center text-slate-900 shadow-lg shadow-slate-200/50 hover:scale-110 transition-transform hover:shadow-xl duration-300 group"
          >
            <svg className="w-6 h-6 group-hover:text-[#0077FF] transition-colors" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            className="w-14 h-14 bg-white rounded-[20px] flex items-center justify-center text-slate-900 shadow-lg shadow-slate-200/50 hover:scale-110 transition-transform hover:shadow-xl duration-300 group"
          >
            <svg className="w-6 h-6 group-hover:text-[#FF0000] transition-colors" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
